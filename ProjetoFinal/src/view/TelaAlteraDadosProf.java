...
public class TelaAlteraDadosProf extends JFrame{
	...
	public TelaAlteraDadosProf(Professor prof, String email) {
	...
	private void inicializarComponentes(Professor prof) {
        ...
        lblNomeCompleto= new JLabel("Nome completo: "+prof.getNomeCompleto());
    	lblNomeUser= new JLabel("Nome de usuário: "+prof.getNomeUsuario());
    	lblEmail = new JLabel("Email: "+prof.getEmail());
		...
		btnAlterarNome.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(senha.equals(prof.getSenha())) {
					...
					if(controla.atualizar(prof, novoNomeCompleto, prof.getNomeUsuario(),
							prof.getSenha(), email)==false) {
						JOptionPane.showMessageDialog(null, "Não foi possível executar a ação!");
						setVisible(false);
						
					}else {
						controla.atualizar(prof, novoNomeCompleto, prof.getNomeUsuario(),
								prof.getSenha(), email);//novo nome completo
							prof.setNomeCompleto(novoNomeCompleto);
		...
		btnAlterarSenha.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(senha.equals(prof.getSenha())) {
					...
					if(controla.atualizarSenha(prof, novaSenha, email)==false) {
						JOptionPane.showMessageDialog(null, "Não foi possível executar a ação!");
						setVisible(false);
						
					}else {
						controla.atualizarSenha(prof, novaSenha, email);
