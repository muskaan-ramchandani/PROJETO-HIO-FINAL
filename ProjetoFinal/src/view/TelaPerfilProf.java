...
public class TelaPerfilProf extends JFrame{
	...
	private JLabel lblPerfilProf;
	
	public TelaPerfilProf (Professor prof){
	...
	private void inicializarComponentes(Professor prof) {
		...
		lblPerfilProf.setForeground(Color.WHITE);
		...
		lblPerfilProf.setFont(new Font("Trebuchet MS", Font.PLAIN, 20));
        ...
        lblPerfilProf.setBounds(80, 15, 250, 20);
        lblIconePerfil.setBounds(100, 200, 298, 300);
        lblUser.setBounds(200, 160, 200, 30);
		...
		lp.add(lblPerfilProf, new Integer(3));
	...
	private void definirEventos(Professor prof) {
		btnPincel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				TelaAlteraUserProf tela = new TelaAlteraUserProf(prof, email);
		...
		btnMeusDados.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String email = prof.getEmail();
				TelaAlteraDadosProf tela = new TelaAlteraDadosProf(prof, email);
		        tela.setLocationRelativeTo(null);
			}
		});
		...
		btnSair.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String email = prof.getEmail();
				TelaDeletaContaProf tela = new TelaDeletaContaProf(prof, email);
		        tela.setLocationRelativeTo(null);
			}
		});
