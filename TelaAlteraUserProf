...
public class TelaAlteraUserProf extends JFrame{
	...
	public TelaAlteraUserProf(Professor prof, String email) {
		...
		btnAlterar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(senha.equals(prof.getSenha())) {
					...
					if(controla.atualizar(prof, prof.getNomeCompleto(), txtNomeUser.getText(),
						...
						controla.atualizar(prof, prof.getNomeCompleto(), txtNomeUser.getText(),
								prof.getSenha(), email);
						JOptionPane.showMessageDialog(null, "Nome de usuário alterado com sucesso!");
						prof.setNomeUsuario(txtNomeUser.getText());
						setVisible(false);
